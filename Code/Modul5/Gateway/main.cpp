...
Adafruit_SH1106 display(OLED_SDA, OLED_SCL);//Oled
...
void displayOled(){
  ...
  display.println(EnigmaIOTGateway.getNetworkName());
  display.setCursor(0,60);
  display.print("n_nodes= ");
  display.println(EnigmaIOTGateway.getActiveNodesNumber ());
  display.display();
}
